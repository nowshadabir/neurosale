...
import { CarServicingAI } from "@/components/dashboard/industries/car-servicing-ai";
import { Bot, Rocket, Construction, ArrowRight } from "lucide-react";
        ...
        return (
          <div className="flex min-h-[70vh] flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-700 fill-mode-both">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-zinc-900">
              AI Intelligence for {category} Coming Soon
            </h2>
            <p className="mt-3 max-w-sm text-zinc-500">
              We're developing a specialized neural network model to predict demand and optimize inventory for the <span className="font-bold text-zinc-900">{category}</span> sector.
            </p>
