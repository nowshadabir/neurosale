...
import { CarServicingDashboard } from "@/components/dashboard/industries/car-servicing";
import { RestaurantLiveSales } from "@/components/dashboard/industries/restaurant-live-sales";
import { Rocket, Construction, ArrowRight } from "lucide-react";
  ...
  const renderDashboard = () => {
    switch (category) {
      case "Car Servicing":
        return (
          <div className="py-4">
            <CarServicingDashboard />
          </div>
        );
      case "Restaurant & Cafe":
        return <RestaurantLiveSales />;
      default:
        return (
          <div className="py-4">
            <div className="flex min-h-[70vh] flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-700 fill-mode-both">
              ...
              <p className="mt-3 max-w-sm text-zinc-500">
                We're currently engineering a specialized, industry-leading analytics experience for the <span className="font-bold text-zinc-900">{category}</span> sector.
              </p>
