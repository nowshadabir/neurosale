...
import { RestaurantFloorMap } from "@/components/dashboard/industries/restaurant-floor-map";
import { Map, Rocket, Construction, ArrowRight, Search, LayoutDashboard } from "lucide-react";
        ...
        return (
          <div className="flex min-h-[70vh] flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-700 fill-mode-both">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-zinc-900">
              Interactive Floor Map for {category} Coming Soon
            </h2>
            <p className="mt-3 max-w-sm text-zinc-500">
              Engineering the most advanced visual table management system with real-time status color-coding and drag-and-drop table merging for the <span className="font-bold text-zinc-900">{category}</span> sector.
            </p>
